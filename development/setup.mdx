...
<Tip>
  To update the projects displayed on the home page, edit `src/constants/projects.js`. Each entry is a plain object with fields like `title`, `description`, and `link`.
</Tip>
